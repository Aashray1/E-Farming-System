...
<label style="color: white" >LIST OF AGRICULTURAL OFFICERS REGISTERED</label>
...
<table class="table table-bordered">
	...
	<tr>
		...
		<td><p><?php echo $a['registered_date']?></p></td>
...
<label style="color: white" >LIST OF SELLERS REGISTERED</label>
<div class="table-responsive">
<table class="table table-bordered">
	<thead class="thead thead-id">
	<tr>
...
<label style="color: white" >LIST OF BUYERS REGISTERED</label>
<div class="table-responsive">
<table class="table table-bordered">
	<thead class="thead thead-id">
	<tr>

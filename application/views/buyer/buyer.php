  ...
  <div class="panel panel-success">
    ...
    <div class="panel-body">		
		<div class="col-sm-8">
			...
			<?php echo $a['firstname']?> <?php echo $a['lastname']?><br>
...
<?php if(($a['quantity']-$a['quantity_selected_by_all_users'])<=0): ?>
    ...
    <div class="panel-heading">Stock Sold Out</div>
    <div class="panel-body">		
		<div class="col-sm-8">
			<p class="b"><strong class="b">NAME: </strong><?php echo $a['product_name']?><br>
			...
			<strong class="b">Price Per Quantity: </strong><?php echo $a['price']?><br>
			<strong class="b">Product Description: </strong><?php echo $a['product_desc']?></p>
			<a href="<?php echo base_url(); ?>buyer/placeorder/<?php echo $a['product_id']?>" class="btn disabled">Place Order</a>
		</div>
		<div class="col-sm-4">
			<img src="<?php echo site_url(); ?>assets/images/crops/<?php echo $a['crop_image']; ?>" style="width:100%">	
		</div>
